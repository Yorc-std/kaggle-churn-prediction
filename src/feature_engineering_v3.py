...
print("=" * 70)
print("特征工程 V4 - 整合高分Notebook优秀特征")
print("=" * 70)
...
for c in YN_COLS:
    if c in df.columns:
        ...
        isyes_isno_features.extend([f"ISYES_{c}", f"ISNO_{c}", f"ISOTHER_{c}"])

feature_count += len(isyes_isno_features)
print(f"  生成 {len(isyes_isno_features)} 个ISYES/ISNO特征")
